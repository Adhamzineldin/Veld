...
class VeldSyntaxHighlighter : SyntaxHighlighterBase() {
    ...
    override fun getTokenHighlights(tokenType: IElementType): Array<TextAttributesKey> {
        return when (tokenType) {
            ...
            VeldTokenTypes.CONSTANTS_KEYWORD -> arrayOf(CONSTANTS_KEYWORD)
            ...
            VeldTokenTypes.EQUALS -> arrayOf(COLON)
    ...
    companion object {
        ...
        val CONSTANTS_KEYWORD = createTextAttributesKey("VELD_CONSTANTS_KEYWORD", DefaultLanguageHighlighterColors.INTERFACE_NAME)
